module "mysql_sg" {
    source = "git::https://github.com/Thirupathi555/terraform-aws-security-group.git?ref=main"
...
resource "aws_security_group_rule" "vpn-public_943" {
  type              = "ingress"
  from_port         = 943
  to_port           = 943
  protocol          = "tcp"
...
resource "aws_security_group_rule" "vpn-public_1194" {
  type              = "ingress"
  from_port         = 1194
  to_port           = 1194
  protocol          = "tcp"
