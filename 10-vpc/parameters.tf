...
resource "aws_ssm_parameter" "public_subnet_ids" {
  ...
  type  = "StringList"                                                # because we have two public subnet ids 
...
resource "aws_ssm_parameter" "private_subnet_ids" {
  ...
  type  = "StringList"                                                 # bebecause we have two private subnet ids 
...
resource "aws_ssm_parameter" "database_subnet_ids" {
  ...
  type  = "StringList"                                                  # because we have two database subnet ids 
